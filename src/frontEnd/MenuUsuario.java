...
/**
 * Clase utiliada para crear menus de los usuarios. Elmenu consistir� en una
 * poregunta, y varias opciones. El objeto se encargara de mostar el resultado,
 * y validar que la respuesta es correcta. Adicionalmente, la clase contiene un
 * conjuntoi de metodos estaticos cuyo objeto es facilitar la lectura de
 * informacion del usuario validada
 * 
 * @author Raul SG
 *
 */
public class MenuUsuario {
	...
	private int i; // Indice por donde vamos a�adiendo las opciones en el array de opciones.
					// Inicialmente vale 0.
	...
	// Constructor
	/**
	 * Constructor de la clase MenuUsuario. Es utilizado para crear un objeto menu
	 * de usuario indicandole la pregunta principal del menu
	 * 
	...
	/**
	 * Metodo utilizado para a�adir las posibles opciones que se van a presentar en
	 * el menu
	 * 
	 * @param opcionNueva que se quiere agregar a las opciones ya existentes
	 * @return devuelve true si se ha podiso agregar, devuelve false, si se ha
	 *         llegado al limite de opciones posibles, y por tanto no se pueden
	...
	/**
	 * Metodo utilizado para leer la opcion elegida por el usuario desde teclado. Se
	 * controla que la eleccion este dentro del numero de opciones disponibles, en
	 * caso contrario se le avisara al usuario y tendra que introducir un numero de
	 * nuevo.
	 * 
	 * @return devuelve la eleccion seleccionada por el usuario, la cual siempre
	 *         estara entre 1 , y el numero de opciones disponibles
	 */
	...
	// Metodo utilizado para mandar un mensaje de error, cuando no se ha
	// seleccionado
	...
	/**
	 * Metodo utilizado para leer por teclado un numero situado entre los
	 * paramnetros inicio, y fin.
	 * 
	 * @param inicio, marca el comienzo del rango. Esta incluido. Para que funcione
	 *                el metodo debe ser menor que el parametro fin
	 * @param fin,    marca el final del rango. Esta incluido. Para que funcione el
	 *                metodo debe ser mayor que el parametro inicio
	...
	/**
	 * Metodo utilizado para leer un numero desde el teclado, mostrando al usuario
	 * una pregunta
	 * 
	 * @param pregunta. Pregunta que se quiere mostrar al usuario antes de leer un
	 *                  valor del teclado.
	...
	/**
	 * Metodo utilizado para leer una cadena de texto, mostrando al usuario una
	 * pregunta
	 * 
	 * @param pregunta. Pregunta que se quiere mostrar al usuario antes de leer un
	 *                  valor del teclado.
	 ...
	 * @return booleano. True, si el usuario elige si, y false si el usuario elige
	 *         no.
	 */
